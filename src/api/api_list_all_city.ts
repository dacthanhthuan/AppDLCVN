...
export default async function api_list_all_city(data: FormData) {
  try {
    const url = await getUrl(baseURL.list_all_city_url);
  ...
  //   getUrl(baseURL.list_all_city_url).then(url => {
