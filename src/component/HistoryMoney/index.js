...
const HistoryMoney = ({ img, datetime_1, money_1, action_1, status_1, datetime_2, money_2, action_2, status_2, style_2, style_4, onPressCancel }) => {
    return (
        <SafeAreaView style={Style_Historymoney.border}>
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={Style_Historymoney.view_1}>
                    ...
                    <View style={Style_Historymoney.view_3}>
                        <Text style={Style_Historymoney.text}>{datetime_2}</Text>
                        <Text style={style_2}>{money_2}</Text>
                        <Text style={Style_Historymoney.text}>{action_2}</Text>
            ...
            {
                status_2 == 'Đang xử lý' ? (
                    <TouchableOpacity style={Style_Historymoney.containerCancel} onPress={onPressCancel}>
                        <Text style={{ color: '#EA4335', }}>Hủy đơn</Text>
                    </TouchableOpacity>
                ) : <></>
            }
        </SafeAreaView >
