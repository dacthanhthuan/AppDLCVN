...
const Detail_User = () => {
  ...
  return (
    <SafeAreaView style={Style_User.container}>
      ...
      />
      <ScrollView
        style={Style_User.scrollview}
        showsVerticalScrollIndicator={false}>
        <View style={Style_User.container_1}>
          <TouchableOpacity>
            <Image
              style={Style_User.imgUser}
              source={require('../../assets/Rectangle312.png')}
            />
            <Image
              style={Style_User.iconCamera}
              source={require('../../assets/imgSupplier/Rectangle_310.png')}
            />
          </TouchableOpacity>
          <Text style={Style_User.nameUser}>{user.fullname}</Text>
        </View>
        ...
        />
        <Detail_Input
          text={'CMND/CCCD/Hộ chiếu(Người nước ngoài)'}
          placeholder={'Chưa có thông tin'}
        />
        ...
        <Detail_Input
          text={
            'Địa chỉ thuờng trú(hoặc đăng ký lưu trú đối với người nước ngoài)'
          }
          placeholder={'Chưa có thông tin'}
        />
        <Detail_Input
          text={'Mã số người bảo trợ'}
          placeholder={'Chưa có thông tin'}
        />
        <Detail_Input
          text={'Họ tên người bảo trợ'}
          placeholder={'Chưa có thông tin'}
        />
        <Detail_Input
          text={
            'Địa chỉ tạm trú(thuờng trú hoặc tạm trú trong trường hợp không cư trú tại nơi thường trú):'
          }
          placeholder={'Chưa có thông tin'}
        />
        <Detail_Input
          text={'Số hợp đồng người bảo trợ'}
          placeholder={'Chưa có thông tin'}
        />
